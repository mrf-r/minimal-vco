...
typedef int32_t s32;
#define MIOS32_USB_MIDI_RX_BUFFER_SIZE 128
#define MIOS32_USB_MIDI_TX_BUFFER_SIZE 128
#define MIOS32_USB_MIDI_NUM_PORTS 1
#define MIOS32_USB_MIDI_DATA_IN_EP USB_EP_MIDI_IN
#define MIOS32_USB_MIDI_DATA_OUT_EP USB_EP_MIDI_OUT
#define MIOS32_USB_MIDI_DATA_IN_SIZE 64
#define USB0 MIDI_CN_USBDEVICE1

void midi_atomic_start(void);
void midi_atomic_end(void);
#define MIOS32_IRQ_Disable midi_atomic_start
#define MIOS32_IRQ_Enable  midi_atomic_end
...
//! \return < 0 on errors
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_MIDI_SendPackageToRxCallback(u32 port_cn, mios32_midi_package_t midi_package)
{
